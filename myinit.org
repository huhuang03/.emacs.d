...
* package Init
** comm help function etc
#+begin_src emacs-lisp
  (defun electric-pair ()
    "If at end of line, insert charater pair without surround space.
  Other wise, just inser tht typed charater."
    (interactive)
...
*** auto pair ~
#+begin_src emacs-lisp
;; this is work. but can I define the in only emacs-mode?
