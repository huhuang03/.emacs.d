...
* Th
** the abbr
*** TODO <se to expand to emacs-lisp code block
        ...
        (progn
          ...
          (cond
           ...
           ((string-equal -fSuffix "go")
            (progn
              (shell-command (concat -prog-name " build " -fname) -output-buffer)
              (shell-command (concat -fnameNoExtension) -output-buffer)))
...
#+BEGIN_SRC emacs-lisp  
  ...
  (define-key evil-normal-state-map " fb" (lambda () (interactive) (neotree-dir "~/source/huhuang03.github.io/posts/")))
