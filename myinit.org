...
(define-key evil-normal-state-map " fp" 'th-open-pass-file)
...
#+END_SRC
* ss mode
  The shadowsocket user rule edit mode
#+BEGIN_SRC emacs-lisp
(setq load-path
    (cons "/Users/th/source/emacs-ss" load-path))
(require 'ss)
#+END_SRC
